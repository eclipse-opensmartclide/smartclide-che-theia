...
exports.CreationalPatterns = void 0;
const data_json_1 = __importDefault(require("./data.json"));
const functions_1 = require("./functions");
class CreationalPatterns {
    creationalPatternswizard(divCont, messageService, helloBackendService) {
        divCont.innerHTML = "";
        ...
        radio11.addEventListener('click', async (e) => {
            divCont2.innerHTML = "";
            ...
            buttonNext1.addEventListener('click', async (e) => {
                ...
                radio31.addEventListener('click', async (e) => {
                    ...
                    let numCat = document.getElementById('subcategoriesNum');
                    numCat.min = '2';
                    ...
                    buttonNext2.addEventListener('click', async (e) => {
                        ...
                        buttonNext3.addEventListener('click', async (e) => {
                            ...
                            radio61.addEventListener('click', async (e) => {
                                divCont7.innerHTML = "";
                                ...
                                buttonNext4.addEventListener('click', async (e) => {
                                    ...
                                    buttonNext5.addEventListener('click', async (e) => {
                                        ...
                                        let buttonCodeAFP = document.getElementById('buttongetcodeAbstractFactoryPattern');
                                        buttonCodeAFP.addEventListener('click', async (e) => {
                                            let infoList = document.getElementsByClassName('infoField');
                                            CreationalPatterns.values["AbstractFactory"].values["AbstractFactory"].name = infoList.item(0).value;
                                            let numCat = parseInt(document.getElementById('subcategoriesNum').value);
                                            let numFam = parseInt(document.getElementById('familiesNum').value);
                            ...
                            radio62.addEventListener('click', async (e) => {
                                divCont7.innerHTML = "";
                                let divCont8 = document.createElement('div');
                                ...
                                radio71.addEventListener('click', async (e) => {
                                    divCont8.innerHTML = "";
                                    let divCont9 = document.createElement('div');
                                    ...
                                    buttonNext6.addEventListener('click', async (e) => {
                                        ...
                                        buttonNext7.addEventListener('click', async (e) => {
                                            ...
                                            let buttonCodeBP = document.getElementById('buttongetcodeBuilderPattern');
                                            buttonCodeBP.addEventListener('click', async (e) => {
                                                let infoList = document.getElementsByClassName('infoField');
                                                let v = document.getElementById('txtboxProduct_name').value + "Builder";
                                                CreationalPatterns.values["Builder"].values["Builder"].name = v;
                                                CreationalPatterns.values["Builder"].values["Director"].name = "Director";
                                                let numCat = parseInt(document.getElementById('subcategoriesNum').value);
                                                let numSteps = parseInt(document.getElementById('stepsNum').value);
                                                for (var i = 1; i <= numCat; i++) {
                                ...
                                radio72.addEventListener('click', async (e) => {
                                    divCont8.innerHTML = "";
                                    let divCont9 = document.createElement('div');
                                    ...
                                    buttonNext8.addEventListener('click', async (e) => {
                                        ...
                                        let buttonCodeFMP = document.getElementById('buttongetcodeFactoryMethodPattern');
                                        buttonCodeFMP.addEventListener('click', async (e) => {
                                            let infoList = document.getElementsByClassName('infoField');
                                            CreationalPatterns.values["FactoryMethod"].values["Product"].name = infoList.item(0).value;
                                            let numCat = parseInt(document.getElementById('subcategoriesNum').value);
                                            for (var i = 1; i <= numCat; i++) {
                                            ...
                                            CreationalPatterns.values["FactoryMethod"].values["Creator"].name = infoList.item(i).value;
        ...
        radio12.addEventListener('click', async (e) => {
            divCont2.innerHTML = "";
            let divCont3 = document.createElement('div');
            ...
            let radio121 = document.getElementById('radio121');
            radio121.addEventListener('click', async (e) => {
                divCont3.innerHTML = "";
                let divCont4 = document.createElement('div');
                ...
                buttonNext9.addEventListener('click', async (e) => {
                    ...
                    let buttonCodeSP = document.getElementById('buttongetcodeSingletonPattern');
                    buttonCodeSP.addEventListener('click', async (e) => {
                        let singlName = document.getElementById('txtboxSingletonName').value;
            ...
            let radio122 = document.getElementById('radio122');
            radio122.addEventListener('click', async (e) => {
                divCont3.innerHTML = "";
                let divCont4 = document.createElement('div');
                ...
                buttonNext10.addEventListener('click', async (e) => {
                    ...
                    let radio1221 = document.getElementById('radio1221');
                    radio1221.addEventListener('click', async (e) => {
                        divCont5.innerHTML = "";
                        let divCont6 = document.createElement('div');
                        ...
                        buttonNext11.addEventListener('click', async (e) => {
                            ...
                            buttonNext12.addEventListener('click', async (e) => {
                                ...
                                let buttonCodePP = document.getElementById('buttongetcodePrototypePattern');
                                buttonCodePP.addEventListener('click', async (e) => {
                                    let infoList = document.getElementsByClassName('infoField');
                                    CreationalPatterns.values["Prototype"].values["Prototype"].name = infoList.item(0).value;
                                    let numCat = parseInt(document.getElementById('subcategoriesNum').value);
                                    for (var i = 1; i <= numCat; i++) {
                    ...
                    let radio1222 = document.getElementById('radio1222');
                    radio1222.addEventListener('click', async (e) => {
                        divCont5.innerHTML = "";
...
exports.CreationalPatterns = CreationalPatterns;
CreationalPatterns.functions = new functions_1.Functions();
CreationalPatterns.values = JSON.parse(JSON.stringify(data_json_1.default));
//# sourceMappingURL=CreationalPatternsWizard.js.map